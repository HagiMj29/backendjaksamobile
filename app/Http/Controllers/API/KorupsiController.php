...
use App\Models\pengadua_tindak_pidana_korupsi;
...
class KorupsiController extends Controller
{
    public function index()
    {
        ...
        $korupsi = pengadua_tindak_pidana_korupsi::with('user')->latest()->get();

        $result = $korupsi->map(function ($data){
            ...
            return [
                ...
                'uraian_singkat_laporan'=>$data->uraian_singkat_laporan,
    ...
    public function store(Request $request)
    {
        ...
        $validatedData = $request->validate([
            ...
            'no_hp' => 'required',
            'nik_ktp' => 'required',
            'uraian_singkat_laporan' =>'required',
        ...
        // Simpan data
        $pengaduan = pengadua_tindak_pidana_korupsi::create(array_merge($validatedData, [
            'status' => 'diproses'
        ]));
    ...
    public function update(Request $request, $id)
{
    ...
    $pengaduan = pengadua_tindak_pidana_korupsi::findOrFail($id);
...
public function destroy(pengadua_tindak_pidana_korupsi $pengadua_tindak_pidana_korupsi)
{
    $pengadua_tindak_pidana_korupsi->delete();
